...
export default function AdminDashboard() {
  ...
  const isAddingProduct = location.pathname === "/admin/products/new";
         ...
         <header className="h-20 border-b border-[#F2E9E1] flex items-center justify-between px-10">
            ...
            <div className="flex items-center space-x-4">
               <button 
                 ...
                 className="bg-[#C2948A] text-white px-5 py-2.5 rounded-md text-[12px] font-semibold uppercase tracking-wider hover:opacity-90 transition-opacity"
               >
                  New Formulation
               </button>
